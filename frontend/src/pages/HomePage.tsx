...
export const HomePage: React.FC = () => {
  ...
  const handleCreateBoard = async () => {
    ...
    try {
      ...
      if (formData.isInfinite) {
        navigate(`/infinite-board?boardId=${newBoard.id}&max=${formData.maxParticipants}`);
      } else {
  ...
  return (
    <div className="modal-overlay" style={{ position: 'relative', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="modal-content">
        ...
        <div className="form-group" style={{ marginTop: '20px', borderTop: '1px solid #ccc', paddingTop: '15px' }}>
        ...
        <div className="modal-actions" style={{ marginTop: '20px' }}>
          <button 
            ...
            disabled={isLoading}
            style={{ width: '100%', backgroundColor: '#4CAF50', color: 'white', padding: '10px', fontSize: '16px' }}
          >
